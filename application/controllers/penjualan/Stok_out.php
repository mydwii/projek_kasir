...
class Stok_out extends CI_Controller
{
    ...
    {
        $this->db->select('stok.id_stok, item.id_item, stok.kode_produk, item.nama as item_nama, jumlah, tanggal, detail, user.username', false);
        $this->db->from('stok');
        ...
        $this->template->load('template', 'penjualan/stok_out', $data);
    }
    ...
    public function delete_data()
    {
        ...
        if ($stok_data) {
            ...
            $this->item_m->hapus_stock_out($data);
